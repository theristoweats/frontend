  ...
  return (
      ...
      <Container>
          <Wrapper>
            ...
            <LoadingMain>
                <Left>
                    <ImgLoaPro src={emptyCart}></ImgLoaPro>
                </Left>
                <Right>
                    <TextNotFf>Празна кошничка</TextNotFf>
                    <AnotherTextMain>Вашата кошничка е празна, додадете некој од продуктите</AnotherTextMain>
                    <ButtonBoxHere>
