                    ...
                    <LeftModal>
                      <LeftModalInside>
                          ...
                          <InputAddresses style={{marginTop:"25px"}}>
                            ...
                            <Input type="text" placeholder="Христо татарчев" id="autoComplement" defaultValue={addressEdit.addressLocation}/>
                          </InputAddresses>

                          <InputAddresses>
                            <InputText>Кратко име</InputText>
                            <Input type="text" placeholder="Кај швалерката" id="addressShortName" defaultValue={addressEdit.addressShortName}/>
                          </InputAddresses>

                          <InputAddresses>
                            <InputText>Детален опис</InputText>
                            <Input type="text" placeholder="Пред зградата има црвен велоспед. Качи се по лифтот од лево кон десно."  id="addressLongDescription"  defaultValue={addressEdit.addressLongDescription}/>
                          </InputAddresses>
